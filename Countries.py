#Countries
#rc_live_74863ab5bd7e49c797c1dc03c66b0714
...
class CountryApp(QWidget):
    ...
    def get_info(self):
        ...
        try:
            api_key = "rc_live_93a2c859c8654a0aacffc55524f63f96"
            url = f"https://api.restcountries.com/countries/v5?q='{country_name}'&appid={api_key}"
            ...
            self.capital.setText("Error fetching data")
    ...
    def info(self, country_data):
        ...
        self.time.setText(f"Timezone: {timezones[0]}")
